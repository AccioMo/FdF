...
static void	ft_print_info_2(void *mlx, void *win, t_map *map, int mo)
{
	...
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Zoom: ");
	mlx_string_put(mlx, win, mo + 150, y, 0xBBBEC0, word);
	free(word);
	word = ft_itoa(map->x_angle * 180 / M_PI);
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Angle X: ");
	mlx_string_put(mlx, win, mo + 150, y, 0xBBBEC0, word);
	free(word);
	word = ft_itoa(map->y_angle * 180 / M_PI);
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Angle Y: ");
	mlx_string_put(mlx, win, mo + 150, y, 0xBBBEC0, word);
	free(word);
	word = ft_itoa(map->z_angle * 180 / M_PI);
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Angle Z: ");
	mlx_string_put(mlx, win, mo + 150, y, 0xBBBEC0, word);
	free(word);
}
...
static void	ft_print_info(void *mlx, void *win, t_map *map, int mo)
{
	...
	y = W_HEIGHT / 2;
	mlx_string_put(mlx, win, mo + 25, y, 0xBBBEC0, "Info:");
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Map: ");
	mlx_string_put(mlx, win, mo + 115, y, 0xBBBEC0, map->name);
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Projection: ");
	mlx_string_put(mlx, win, mo + 175, y, 0xBBBEC0, map->projection);
	word = ft_itoa(map->height * map->zoom);
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Height: ");
	mlx_string_put(mlx, win, mo + 150, y, 0xBBBEC0, word);
	free(word);
	word = ft_itoa(map->width * map->zoom);
	y += 40;
	mlx_string_put(mlx, win, mo + 50, y, 0xBBBEC0, "Width: ");
	mlx_string_put(mlx, win, mo + 150, y, 0xBBBEC0, word);
	free(word);
